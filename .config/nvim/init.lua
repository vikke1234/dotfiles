...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'bibtex', 'latex' },
...
local function is_function_call(entry)
  return entry ~= nil and entry.completion_item ~= nil and
    (
    entry.completion_item.kind == cmp.lsp.CompletionItemKind.Constant or
    entry.completion_item.kind == cmp.lsp.CompletionItemKind.Field or
    entry.completion_item.kind == cmp.lsp.CompletionItemKind.Variable
  )
end
    ...
    ['<C-Space>'] = cmp.mapping(function (fallback)
      if cmp.visible() then
        ...
        vim.schedule(function ()
          ...
          if is_function_call(selected_entry) and luasnip.expand_or_locally_jumpable() then
